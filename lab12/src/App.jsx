...
function App() {
  ...
  function mostrar(cod, index) {
    axios.get("http://localhost:8000/serie/" + cod).then((res) => {
      setPos(index);
      setTitulo("Editar");
      setId(res.data.id);
  ...
  function eliminar(cod) {
    ...
    if (rpta) {
      axios.delete("http://localhost:8000/serie/" + cod).then((res) => {
              ...
              return (
                <tr key={serie.id}>
                  ...
                  <td>
                    <Button
                      variant="warning"
                      onClick={() => mostrar(serie.id, index)}
                    >
                      Editar
                    </Button>
                    <Button variant="danger" onClick={() => eliminar(serie.id)}>
                      Eliminar
                    </Button>
                  </td>
                </tr>
